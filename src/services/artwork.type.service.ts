 ...
 */
export class ArtWorkTypeService extends BaseService<
  IBAseQualifier,
  Partial<IBaseParams>
> {
  public static instance: ArtWorkTypeService | null = null;

  constructor() {
    super({ path: paths['artwork-types'] });
  }
  /**
   *
  ...
  public static get getInstance() {
    if (ArtWorkTypeService.instance) return ArtWorkTypeService.instance;
    else {
