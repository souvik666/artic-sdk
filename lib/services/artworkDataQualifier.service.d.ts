 ...
 */
export declare class ArtWorkDataQualifierService extends BaseService<IBAseQualifier, Partial<IBaseParams>> {
    static instance: ArtWorkDataQualifierService | null;
    constructor();
    /**
     *
     ...
     */
    static get getInstance(): ArtWorkDataQualifierService;
}
