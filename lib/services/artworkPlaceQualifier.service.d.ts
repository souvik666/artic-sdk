 ...
 */
export declare class ArtworkPlaceQualifierService extends BaseService<IBAseQualifier, Partial<IBaseParams>> {
    static instance: ArtworkPlaceQualifierService | null;
    constructor();
    /**
     *
     ...
     */
    static get getInstance(): ArtworkPlaceQualifierService;
}
